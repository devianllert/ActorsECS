...
namespace ActorsECS.Modules.Enemy.Components
 {
   ...
   static partial class Component
   {
     ...
     public static ref ComponentChase ComponentChase(in this ent entity) =>
       ref Storage<ComponentChase>.components[entity.id];
   }

   [Il2CppSetOption(Option.NullChecks, false)]
   [Il2CppSetOption(Option.ArrayBoundsChecks, false)]
   [Il2CppSetOption(Option.DivideByZeroChecks, false)]
   sealed class StorageComponentChase : Storage<ComponentChase>
   {
     public override ComponentChase Create() => new ComponentChase();
