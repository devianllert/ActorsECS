...
namespace ActorsECS.Modules.Enemy.Components
 {
   ...
   static partial class Component
   {
     ...
     public static ref ComponentPatrol ComponentPatrol(in this ent entity) =>
       ref Storage<ComponentPatrol>.components[entity.id];
   }

   [Il2CppSetOption(Option.NullChecks, false)]
   [Il2CppSetOption(Option.ArrayBoundsChecks, false)]
   [Il2CppSetOption(Option.DivideByZeroChecks, false)]
   sealed class StorageComponentPatrol : Storage<ComponentPatrol>
   {
     public override ComponentPatrol Create() => new ComponentPatrol();
