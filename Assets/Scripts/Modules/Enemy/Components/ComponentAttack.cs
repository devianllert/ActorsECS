...
namespace ActorsECS.Modules.Enemy.Components
 {
   ...
   static partial class Component
   {
     ...
     public static ref ComponentDefault ComponentDefault(in this ent entity) =>
       ref Storage<ComponentDefault>.components[entity.id];
   }

   [Il2CppSetOption(Option.NullChecks, false)]
   [Il2CppSetOption(Option.ArrayBoundsChecks, false)]
   [Il2CppSetOption(Option.DivideByZeroChecks, false)]
   sealed class StorageComponentDefault : Storage<ComponentDefault>
   {
     public override ComponentDefault Create() => new ComponentDefault();
