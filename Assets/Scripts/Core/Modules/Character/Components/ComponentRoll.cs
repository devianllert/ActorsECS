...
namespace ActorsECS.Core.Modules.Character.Components
{
  [Serializable]
  ...
  internal static partial class Component
  {
    ...
    {
      return ref Storage<ComponentRoll>.components[entity.id];
    }
  }
  ...
  [Il2CppSetOption(Option.ArrayBoundsChecks, false)]
  [Il2CppSetOption(Option.DivideByZeroChecks, false)]
  internal sealed class StorageComponentRoll : Storage<ComponentRoll>
  {
    public override ComponentRoll Create()
    {
      return new ComponentRoll();
    }
