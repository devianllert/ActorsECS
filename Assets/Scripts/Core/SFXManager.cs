...
namespace ActorsECS.Core
{
  ...
  public class SFXManager : MonoCached
  {
    ...
    [Header("Defaults")] public AudioClip[] defaultSwingSound;
    ...
    [SerializeField] private AudioSource[] prefabs;
    [SerializeField] private int[] poolAmount;

    private Queue<AudioSource>[] _mInstances;
  ...
  {
    private SerializedProperty m_DefaultHitSoundProp;
    private SerializedProperty m_DefaultItemEquippedSound;
    private SerializedProperty m_DefaultItemUsedSound;
    private SerializedProperty m_DefaultPickupSoundProp;
    private SerializedProperty m_DefaultSwingSoundProp;
    private SerializedProperty m_ListenerProp;
    private SerializedProperty m_ListenerTargetProp;
    private SerializedProperty m_PoolAmountProp;
    private SerializedProperty m_PrefabsArrayProp;
    ...
    public override void OnInspectorGUI()
    {
      ...
      for (var i = 0; i < m_PrefabsArrayProp.arraySize; ++i)
      {
        ...
        EditorGUILayout.PropertyField(m_PrefabsArrayProp.GetArrayElementAtIndex(i),
          new GUIContent(((SFXManager.Use) i).ToString()));
