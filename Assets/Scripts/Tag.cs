...
namespace ActorsECS
{
  public static class Tag
  {
    ...
    [TagField(categoryName = "Affliction")] public const int Afflicted = 100;
    [TagField(categoryName = "Affliction")] public const int Stun = 101;
    [TagField(categoryName = "Affliction")] public const int Burn = 102;
    [TagField(categoryName = "Affliction")] public const int Acid = 103;
    [TagField(categoryName = "Affliction")] public const int Chill = 104;
